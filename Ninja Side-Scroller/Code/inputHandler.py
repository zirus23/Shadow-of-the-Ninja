"""
TEXT INPUT LIBRARY FOR PYGAME


THIS FILE WAS NOT WRITTEN BY ME. ONLY USED TO ENTER TEXT IN-GAME. It was used only due to a shortage of time, and has nearly no code complexity. (this is a pygame shortcoming, and is something that pygame itself could easily have had a sub-module for)
